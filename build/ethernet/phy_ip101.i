# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_ip101.c"
# 1 "/home/raphael/rtone/lcd/build/ethernet//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_ip101.c"
# 14 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_ip101.c"
...
# 15 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_ip101.c" 2
...
# 16 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_ip101.c" 2
...
# 17 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_ip101.c" 2
# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/include/eth_phy/phy_ip101.h" 1
# 15 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/include/eth_phy/phy_ip101.h"
...
# 22 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/include/eth_phy/phy_ip101.h" 2
...
void phy_ip101_power_enable(
# 53 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/include/eth_phy/phy_ip101.h" 3 4
                           _Bool
# 53 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/include/eth_phy/phy_ip101.h"
                               );
# 62 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/include/eth_phy/phy_ip101.h"
esp_err_t phy_ip101_init(void);
# 71 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/include/eth_phy/phy_ip101.h"
extern const eth_config_t phy_ip101_default_ethernet_config;
# 18 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_ip101.c" 2
# 27 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_ip101.c"
...
eth_speed_mode_t phy_ip101_get_speed_mode(void)
{
    if ((esp_eth_smi_read((0x1e)) & (1UL << (1))) == (1UL << (1))) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "phy_ip101_get_speed_mode(100)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "phy_ip101_get_speed_mode(100)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_ip101_get_speed_mode(100)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "phy_ip101_get_speed_mode(100)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "phy_ip101_get_speed_mode(100)" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return ETH_SPEED_MODE_100M;
    } else {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "phy_ip101_get_speed_mode(10)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "phy_ip101_get_speed_mode(10)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_ip101_get_speed_mode(10)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "phy_ip101_get_speed_mode(10)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "phy_ip101_get_speed_mode(10)" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
...
eth_duplex_mode_t phy_ip101_get_duplex_mode(void)
{
    if ((esp_eth_smi_read((0x1e)) & (1UL << (2))) == (1UL << (2))) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "phy_ip101_get_duplex_mode(FULL)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "phy_ip101_get_duplex_mode(FULL)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_ip101_get_duplex_mode(FULL)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "phy_ip101_get_duplex_mode(FULL)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "phy_ip101_get_duplex_mode(FULL)" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return ETH_MODE_FULLDUPLEX;
    } else {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "phy_ip101_get_duplex_mode(HALF)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "phy_ip101_get_duplex_mode(HALF)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_ip101_get_duplex_mode(HALF)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "phy_ip101_get_duplex_mode(HALF)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "phy_ip101_get_duplex_mode(HALF)" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return ETH_MODE_HALFDUPLEX;
    }
}

void phy_ip101_power_enable(
# 57 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_ip101.c" 3 4
                           _Bool 
# 57 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_ip101.c"
                                enable)
{
    if (enable) {
...
{
    esp_err_t res1, res2;
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "phy_ip101_init()" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "phy_ip101_init()" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_ip101_init()" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "phy_ip101_init()" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "phy_ip101_init()" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    phy_ip101_dump_registers();
    do {

        res1 = esp_eth_smi_wait_value((0x2), 0x243, 0xffff, 1000);
        res2 = esp_eth_smi_wait_value((0x3), 0xc54, 0xFFF0, 1000);
    } while (res1 != 0 || res2 != 0);
    ets_delay_us(300);
...
const eth_config_t phy_ip101_default_ethernet_config = {
    ...
    .flow_ctrl_enable = 
# 92 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_ip101.c" 3 4
                       1
# 92 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_ip101.c"
                           ,
...
void phy_ip101_dump_registers()
{
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "IP101 Registers:" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "IP101 Registers:" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "IP101 Registers:" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "IP101 Registers:" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "IP101 Registers:" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "PSCR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x16)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "PSCR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x16)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "PSCR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x16)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "PSCR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x16)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "PSCR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x16)); } } while(0); } while(0);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ISR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x17)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ISR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x17)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ISR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x17)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ISR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x17)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ISR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x17)); } } while(0); } while(0);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ICR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x18)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ICR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x18)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ICR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x18)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ICR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x18)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ICR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x18)); } } while(0); } while(0);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "CSSR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x30)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "CSSR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x30)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "CSSR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x30)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "CSSR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x30)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "CSSR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x30)); } } while(0); } while(0);
}
