	...
	.text
.Ltext0:
	.section	.text.phy_ip101_check_phy_init,"ax",@progbits
	.align	4
	.global	phy_ip101_check_phy_init
	.type	phy_ip101_check_phy_init, @function
phy_ip101_check_phy_init:
.LFB1:
	.file 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_ip101.c"
	.loc 1 30 0
	entry	sp, 32
.LCFI0:
.LVL0:
...
.LBE4:
.LFE1:
	.size	phy_ip101_check_phy_init, .-phy_ip101_check_phy_init
	.section	.text.phy_ip101_get_speed_mode,"ax",@progbits
	.align	4
	.global	phy_ip101_get_speed_mode
	.type	phy_ip101_get_speed_mode, @function
...
.L4:
	...
	retw.n
.LFE2:
	.size	phy_ip101_get_speed_mode, .-phy_ip101_get_speed_mode
	.section	.text.phy_ip101_get_duplex_mode,"ax",@progbits
	.align	4
	.global	phy_ip101_get_duplex_mode
	.type	phy_ip101_get_duplex_mode, @function
...
.L7:
	...
	retw.n
.LFE3:
	.size	phy_ip101_get_duplex_mode, .-phy_ip101_get_duplex_mode
	.section	.text.phy_ip101_power_enable,"ax",@progbits
	.literal_position
	.literal .LC0, 4608
	.align	4
	.global	phy_ip101_power_enable
	.type	phy_ip101_power_enable, @function
...
.LBE6:
.LFE4:
	.size	phy_ip101_power_enable, .-phy_ip101_power_enable
	.section	.text.phy_ip101_init,"ax",@progbits
	.literal_position
	.literal .LC1, 65535
	.literal .LC2, 65520
	.literal .LC3, 3156
	.align	4
	.global	phy_ip101_init
	.type	phy_ip101_init, @function
phy_ip101_init:
.LFB5:
	.loc 1 69 0
	entry	sp, 32
...
.L12:
	...
	retw.n
.LFE5:
	.size	phy_ip101_init, .-phy_ip101_init
	.section	.text.phy_ip101_dump_registers,"ax",@progbits
	.align	4
	.global	phy_ip101_dump_registers
	.type	phy_ip101_dump_registers, @function
...
.LCFI5:
	retw.n
.LFE6:
	.size	phy_ip101_dump_registers, .-phy_ip101_dump_registers
	.global	phy_ip101_default_ethernet_config
	.section	.rodata.phy_ip101_default_ethernet_config,"a",@progbits
	.align	4
	.type	phy_ip101_default_ethernet_config, @object
	.size	phy_ip101_default_ethernet_config, 56
phy_ip101_default_ethernet_config:
	...
	.word	phy_ip101_check_phy_init
	.word	phy_ip101_get_speed_mode
	.word	phy_ip101_get_duplex_mode
	.zero	4
	.byte	1
	.zero	3
	.word	phy_mii_get_partner_pause_enable
	.word	phy_ip101_power_enable
	.zero	4
...
.Ldebug_info0:
	...
	.uleb128 0x5
	.byte	0x3
	.4byte	phy_ip101_default_ethernet_config
	.uleb128 0x8
	.4byte	0x3f6
	.uleb128 0x21
	.4byte	.LASF107
...
.LASF113:
	.string	"/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_ip101.c"
.LASF68:
	.string	"PHY30"
.LASF69:
	.string	"PHY31"
...
.LASF82:
	.string	"mac_mode"
.LASF118:
	.string	"phy_ip101_default_ethernet_config"
.LASF30:
...
.LASF7:
	.string	"unsigned int"
.LASF101:
	.string	"phy_ip101_check_phy_init"
.LASF10:
	.string	"uint16_t"
.LASF32:
...
.LASF100:
	.string	"phy_ip101_get_duplex_mode"
.LASF88:
...
.LASF81:
	.string	"phy_addr"
.LASF99:
	.string	"phy_ip101_get_speed_mode"
.LASF27:
	.string	"ETH_CLOCK_GPIO0_IN"
.LASF5:
	.string	"__int32_t"
.LASF117:
	.string	"phy_ip101_dump_registers"
.LASF96:
	.string	"reg_num"
.LASF80:
