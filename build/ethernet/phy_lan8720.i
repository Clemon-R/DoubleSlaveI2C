# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_lan8720.c"
# 1 "/home/raphael/rtone/lcd/build/ethernet//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_lan8720.c"
# 14 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_lan8720.c"
...
# 15 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_lan8720.c" 2
...
# 16 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_lan8720.c" 2
...
# 17 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_lan8720.c" 2
# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/include/eth_phy/phy_lan8720.h" 1
# 15 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/include/eth_phy/phy_lan8720.h"
...
# 22 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/include/eth_phy/phy_lan8720.h" 2
...
# 53 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/include/eth_phy/phy_lan8720.h" 3 4
                             _Bool
# 53 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/include/eth_phy/phy_lan8720.h"
                                 );
# 62 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/include/eth_phy/phy_lan8720.h"
esp_err_t phy_lan8720_init(void);
# 71 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/include/eth_phy/phy_lan8720.h"
extern const eth_config_t phy_lan8720_default_ethernet_config;
# 18 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_lan8720.c" 2
# 34 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_lan8720.c"
...
eth_speed_mode_t phy_lan8720_get_speed_mode(void)
{
    if (esp_eth_smi_read((0x1f)) & (1UL << (3))) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "phy_lan8720_get_speed_mode(100)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "phy_lan8720_get_speed_mode(100)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_lan8720_get_speed_mode(100)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "phy_lan8720_get_speed_mode(100)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "phy_lan8720_get_speed_mode(100)" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return ETH_SPEED_MODE_100M;
    } else {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "phy_lan8720_get_speed_mode(10)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "phy_lan8720_get_speed_mode(10)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_lan8720_get_speed_mode(10)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "phy_lan8720_get_speed_mode(10)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "phy_lan8720_get_speed_mode(10)" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
...
eth_duplex_mode_t phy_lan8720_get_duplex_mode(void)
{
    if (esp_eth_smi_read((0x1f)) & (1UL << (4))) {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "phy_lan8720_get_duplex_mode(FULL)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "phy_lan8720_get_duplex_mode(FULL)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_lan8720_get_duplex_mode(FULL)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "phy_lan8720_get_duplex_mode(FULL)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "phy_lan8720_get_duplex_mode(FULL)" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return ETH_MODE_FULLDUPLEX;
    } else {
        do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "phy_lan8720_get_duplex_mode(HALF)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "phy_lan8720_get_duplex_mode(HALF)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_lan8720_get_duplex_mode(HALF)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "phy_lan8720_get_duplex_mode(HALF)" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "phy_lan8720_get_duplex_mode(HALF)" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
        return ETH_MODE_HALFDUPLEX;
    }
}

void phy_lan8720_power_enable(
# 66 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_lan8720.c" 3 4
                             _Bool 
# 66 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_lan8720.c"
                                  enable)
{
    if (enable) {
        uint32_t data = esp_eth_smi_read((0x0));
        data |= (1UL << (12)) | (1UL << (9));
        esp_eth_smi_write((0x0), data);
...
esp_err_t phy_lan8720_init(void)
{
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "phy_lan8720_init()" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "phy_lan8720_init()" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_lan8720_init()" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "phy_lan8720_init()" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "phy_lan8720_init()" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    phy_lan8720_dump_registers();
...
const eth_config_t phy_lan8720_default_ethernet_config = {
    ...
    .flow_ctrl_enable = 
# 109 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_lan8720.c" 3 4
                       1
# 109 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/ethernet/eth_phy/phy_lan8720.c"
                           ,
...
void phy_lan8720_dump_registers()
{
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "LAN8720 Registers:" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "LAN8720 Registers:" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "LAN8720 Registers:" "\033[0m" "\n", esp_log_timestamp(), TAG); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "LAN8720 Registers:" "\033[0m" "\n", esp_log_timestamp(), TAG); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "LAN8720 Registers:" "\033[0m" "\n", esp_log_timestamp(), TAG); } } while(0); } while(0);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "BCR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x0)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "BCR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x0)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "BCR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x0)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "BCR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x0)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "BCR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x0)); } } while(0); } while(0);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "BSR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x1)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "BSR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x1)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "BSR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x1)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "BSR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x1)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "BSR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x1)); } } while(0); } while(0);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "PHY1   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x2)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "PHY1   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x2)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "PHY1   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x2)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "PHY1   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x2)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "PHY1   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x2)); } } while(0); } while(0);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "PHY2   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x3)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "PHY2   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x3)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "PHY2   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x3)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "PHY2   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x3)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "PHY2   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x3)); } } while(0); } while(0);
    ...
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "MCSR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x17)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "MCSR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x17)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "MCSR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x17)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "MCSR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x17)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "MCSR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x17)); } } while(0); } while(0);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SM     0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x18)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SM     0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x18)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SM     0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x18)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SM     0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x18)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SM     0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x18)); } } while(0); } while(0);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "SECR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x26)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "SECR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x26)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SECR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x26)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "SECR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x26)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "SECR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x26)); } } while(0); } while(0);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "CSIR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x27)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "CSIR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x27)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "CSIR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x27)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "CSIR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x27)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "CSIR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x27)); } } while(0); } while(0);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "ISR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x29)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "ISR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x29)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ISR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x29)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ISR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x29)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "ISR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x29)); } } while(0); } while(0);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "IMR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x30)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "IMR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x30)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "IMR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x30)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "IMR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x30)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "IMR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x30)); } } while(0); } while(0);
    do { if ( 3 >= ESP_LOG_DEBUG ) do { if (ESP_LOG_DEBUG==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "PSCSR  0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x31)); } else if (ESP_LOG_DEBUG==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "PSCSR  0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x31)); } else if (ESP_LOG_DEBUG==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "PSCSR  0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x31)); } else if (ESP_LOG_DEBUG==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "PSCSR  0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x31)); } else { esp_log_write(ESP_LOG_INFO, TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "PSCSR  0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x31)); } } while(0); } while(0);
}
