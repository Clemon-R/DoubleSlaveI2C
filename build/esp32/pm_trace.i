# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp32/pm_trace.c"
# 1 "/home/raphael/rtone/lcd/build/esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp32/pm_trace.c"
# 16 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp32/pm_trace.c"
...
# 17 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp32/pm_trace.c" 2
...
# 611 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/driver/include/driver/gpio.h"
                                                    oen_inv);
# 18 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp32/pm_trace.c" 2
...
{
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff44000 + 0x0008))) >= 0x3ff00000) && (((0x3ff44000 + 0x0008))) <= 0x3ff13FFC)), (!(((((0x3ff44000 + 0x0008))) >= 0x3ff00000) && (((0x3ff44000 + 0x0008))) <= 0x3ff13FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff44000 + 0x0008))) >= 0x3ff00000) && (((0x3ff44000 + 0x0008))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp32/pm_trace.c", 46, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff44000 + 0x0008))) >= 0x3ff00000) && (((0x3ff44000 + 0x0008))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff44000 + 0x0008))) = (s_trace_io[2 * event + core_id]); });
}

void __attribute__((section(".iram1"))) esp_pm_trace_exit(esp_pm_trace_event_t event, int core_id)
{
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff44000 + 0x000c))) >= 0x3ff00000) && (((0x3ff44000 + 0x000c))) <= 0x3ff13FFC)), (!(((((0x3ff44000 + 0x000c))) >= 0x3ff00000) && (((0x3ff44000 + 0x000c))) <= 0x3ff13FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff44000 + 0x000c))) >= 0x3ff00000) && (((0x3ff44000 + 0x000c))) <= 0x3ff13FFC))) ? (void)0 : __assert_func ("/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp32/pm_trace.c", 51, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff44000 + 0x000c))) >= 0x3ff00000) && (((0x3ff44000 + 0x000c))) <= 0x3ff13FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff44000 + 0x000c))) = (s_trace_io[2 * event + core_id]); });
}
