...
arg_date_resetfn:
.LFB1:
	.file 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/console/argtable3/argtable3.c"
	.loc 1 851 0
.LVL0:
	entry	sp, 32
.LCFI0:
...
.LVL12:
	...
	extui	a8, a8, 0, 2
	bnei	a8, 1, .L9
	.loc 1 1088 0 discriminator 5
	addi	a3, a11, 32
.LVL13:
	j	.L10
.LVL14:
.L9:
	.loc 1 1088 0 discriminator 6
	mov.n	a3, a11
.LVL15:
.L10:
.LBE4:
	.loc 1 1088 0 discriminator 8
	beq	a12, a3, .L11
.LVL16:
.LBB5:
...
.LVL29:
.L21:
	.loc 1 1104 0 discriminator 6
	mov.n	a3, a11
.LVL30:
.L22:
.LBE10:
	.loc 1 1104 0 discriminator 8
	beq	a12, a3, .L23
.LVL31:
.LBB11:
...
.LVL108:
	...
	extui	a2, a2, 0, 3
	bnez.n	a2, .L93
	.loc 1 3264 0 is_stmt 0 discriminator 2
	movi.n	a2, 0x5f
	bne	a9, a2, .L94
	.loc 1 3264 0
	movi.n	a2, 1
...
.L102:
.LBE16:
	.loc 1 3289 0 discriminator 4
	blt	a10, a12, .L103
.LBB17:
	.loc 1 3289 0 discriminator 5
	l32i.n	a12, a3, 8
.LVL138:
	add.n	a13, a11, a12
	l8ui	a13, a13, 1
	extui	a13, a13, 0, 2
	bnei	a13, 2, .L104
	.loc 1 3289 0 discriminator 6
	addi	a12, a12, -32
.LVL139:
.L104:
.LBE17:
	.loc 1 3289 0 discriminator 9
	bge	a12, a10, .L115
.LVL140:
.L103:
.LBB18:
...
.LVL142:
	...
	extui	a9, a9, 0, 2
	bnei	a9, 1, .L108
	.loc 1 3290 0 discriminator 6
	addi	a8, a8, 32
.LVL143:
.L108:
.LBE19:
	.loc 1 3290 0 discriminator 9
	blt	a8, a10, .L107
	j	.L118
.LVL144:
.L101:
...
.L110:
.LBE20:
	.loc 1 3303 0 discriminator 4
	beq	a11, a10, .L122
.LVL147:
.LBB21:
	.loc 1 3303 0 discriminator 6
	bnei	a9, 2, .L111
	.loc 1 3303 0 discriminator 7
	addi	a8, a8, -32
.LVL148:
.L111:
.LBE21:
	.loc 1 3303 0 discriminator 10
	bne	a8, a10, .L107
	j	.L123
.LVL149:
.L109:
...
.LVL361:
.L236:
	.loc 1 3961 0 discriminator 4
	add.n	a4, a4, a10
.LVL362:
.LBE36:
	.loc 1 3958 0 is_stmt 1 discriminator 4
	addi.n	a3, a3, 1
.LVL363:
.L235:
	.loc 1 3958 0 is_stmt 0 discriminator 2
	addx4	a8, a3, a2
	l32i.n	a8, a8, 0
	l8ui	a9, a8, 0
	bbci	a9, 0, .L237
...
.L240:
	.loc 1 3977 0
	beqz.n	a8, .L243
	.loc 1 3977 0 is_stmt 0 discriminator 1
	l8ui	a12, a8, 0
	bnez.n	a12, .L244
.L243:
.LBE38:
	.loc 1 3973 0 is_stmt 1 discriminator 2
	addi.n	a3, a3, 1
.LVL377:
.L239:
...
.L265:
.LVL404:
	.loc 1 1863 0 is_stmt 1 discriminator 4
	movi.n	a8, 1
	movi.n	a9, 0
	mov.n	a3, a9
	movnez	a3, a8, a2
...
.L272:
.LVL420:
	.loc 1 1839 0 is_stmt 1 discriminator 4
	beqz.n	a10, .L280
	.loc 1 1840 0
	addi.n	a2, a10, 1
.LVL421:
...
.LBE41:
.LBB42:
	.loc 1 2119 0 discriminator 4
	add.n	a10, a10, a4
	l8ui	a9, a10, 1
	extui	a9, a9, 0, 2
	bnei	a9, 2, .L295
	.loc 1 2119 0 discriminator 5
	addi	a4, a4, -32
.LVL454:
.L295:
.LBE42:
	.loc 1 2119 0 discriminator 8
	beq	a8, a4, .L296
...
.LBE53:
	...
	movnez	a9, a12, a10
	bnone	a4, a9, .L388
	.loc 1 3225 0 is_stmt 0 discriminator 1
	movi.n	a4, 0x2a
	beq	a8, a4, .L388
	.loc 1 3225 0 discriminator 2
	movi.n	a4, 0x2b
	beq	a8, a4, .L388
	.loc 1 3225 0 discriminator 3
	beqz.n	a8, .L388
.LBB55:
...
.L414:
	...
	movi.n	a10, 1
.L399:
	.loc 1 3884 0 discriminator 4
	add.n	a7, a7, a10
.LVL657:
	.loc 1 3885 0 is_stmt 1 discriminator 4
	j	.L400
.L401:
	.loc 1 3887 0
	addi.n	a6, a6, 1
...
.L411:
.LBE59:
	.loc 1 3910 0 is_stmt 1 discriminator 2
	addi.n	a5, a5, 1
.LVL681:
.L404:
...
.LVL707:
	...
	l8ui	a8, a8, 0
	bnez.n	a8, .L430
	.loc 1 4057 0 is_stmt 1 discriminator 2
	l8ui	a8, a9, 0
...
.LVL827:
.L466:
	.loc 1 4570 0 discriminator 1
	addx4	a8, a4, a3
	l32i.n	a8, a8, 0
	.loc 1 4569 0 discriminator 1
	beqz.n	a8, .L469
	.loc 1 4570 0
	l8ui	a9, a8, 0
	bbci	a9, 0, .L470
...
.LVL838:
.L476:
	.loc 1 993 0 is_stmt 0 discriminator 4
	s32i.n	a5, a10, 12
...
.LVL1014:
.L602:
	.loc 1 1999 0 is_stmt 0 discriminator 4
	s32i.n	a4, a10, 12
...
.LVL1016:
	add.n	a2, a2, a3
	s32i.n	a2, a10, 60
	.loc 1 2011 0 discriminator 4
	add.n	a2, a2, a3
	s32i	a2, a10, 64
	.loc 1 2012 0 discriminator 4
	movi.n	a2, 0
	s32i.n	a2, a10, 52
.LVL1017:
	.loc 1 2015 0 discriminator 4
	j	.L603
.LVL1018:
.L604:
...
.LVL1032:
.L610:
	.loc 1 2351 0 is_stmt 0 discriminator 4
	s32i.n	a4, a10, 12
...
.LVL1095:
.L634:
	.loc 1 2871 0 is_stmt 0 discriminator 4
	s32i.n	a5, a3, 12
	.loc 1 2872 0 is_stmt 1 discriminator 4
	l32i	a2, sp, 68
	s32i.n	a2, a3, 16
	...
	l32r	a2, .LC167
	s32i.n	a2, a3, 36
	.loc 1 2878 0 discriminator 4
	l32r	a2, .LC168
	s32i.n	a2, a3, 40
	.loc 1 2879 0 discriminator 4
	l32r	a2, .LC169
	s32i.n	a2, a3, 44
...
.LVL1097:
	...
	s32i.n	a4, a3, 60
	.loc 1 2885 0 discriminator 4
	l32i	a2, sp, 64
	s32i.n	a2, a6, 4
	.loc 1 2888 0 discriminator 4
	addi	a2, a3, 68
	s32i.n	a2, a3, 56
	.loc 1 2889 0 discriminator 4
	movi.n	a2, 0
	s32i.n	a2, a3, 52
.LVL1098:
	.loc 1 2892 0 discriminator 4
	j	.L635
.LVL1099:
.L636:
...
.LVL1102:
	...
	l32i.n	a11, sp, 0
	bnez.n	a11, .L638
	.loc 1 2904 0 is_stmt 0
	l32r	a11, .LC161
.L638:
	.loc 1 2904 0 discriminator 5
	l32i.n	a12, a3, 60
	l32r	a10, .LC172
	call8	dbg_printf
.LVL1103:
	.loc 1 2905 0 is_stmt 1 discriminator 5
	l32r	a10, .LC174
	call8	dbg_printf
.LVL1104:
.L637:
...
.LVL1174:
.L674:
	.loc 1 3735 0 is_stmt 0 discriminator 4
	s32i.n	a4, a10, 12
	.loc 1 3736 0 is_stmt 1 discriminator 4
	s32i.n	a7, a10, 16
...
.LVL1213:
	.loc 1 4527 0 discriminator 4
	mov.n	a11, a2
	addi	a10, sp, 16
	call8	fputs
.LVL1214:
	.loc 1 4528 0 discriminator 4
	mov.n	a11, a2
	mov.n	a10, a6
	call8	fputs
.LVL1215:
...
.LVL1259:
.L712:
	.loc 1 2280 0 discriminator 4
	l32r	a11, .LC216
	mov.n	a10, a3
	call8	fprintf
.LVL1260:
	.loc 1 2281 0 discriminator 4
	beqi	a4, 2, .L714
	bgei	a4, 3, .L715
	beqi	a4, 1, .L716
	retw.n
...
.LVL1283:
.L724:
	.loc 1 2768 0 discriminator 4
	l32r	a11, .LC232
	mov.n	a10, a3
	call8	fprintf
.LVL1284:
	.loc 1 2769 0 discriminator 4
	beqi	a4, 2, .L726
	beqi	a4, 7, .L727
	bnei	a4, 1, .L723
	.loc 1 2772 0
...
.LVL1295:
.L730:
	.loc 1 3671 0 discriminator 4
	l32r	a11, .LC239
	mov.n	a10, a3
	call8	fprintf
.LVL1296:
	.loc 1 3672 0 discriminator 4
	beqi	a4, 1, .L732
	beqi	a4, 2, .L733
	retw.n
.L732:
...
.LVL1308:
.L740:
	.loc 1 4630 0 discriminator 3
	mov.n	a12, sp
	l32r	a11, .LC244
	mov.n	a10, a2
	call8	fprintf
.LVL1309:
	.loc 1 4629 0 discriminator 3
	addi.n	a5, a5, 1
.LVL1310:
	j	.L738
.LVL1311:
...
.L782:
.LBE91:
	.loc 1 4840 0 discriminator 2
	addi.n	a6, a6, 1
.LVL1383:
.L781:
	.loc 1 4840 0 is_stmt 0 discriminator 1
	addx4	a5, a6, a3
	l32i.n	a4, a5, 0
	l8ui	a7, a4, 0
	bbci	a7, 0, .L785
...
.Letext0:
	...
	.file 3 "/home/raphael/espressif/tools/esp32-toolchain/linux/xtensa-esp32-elf/lib/gcc/xtensa-esp32-elf/5.2.0/include/stdarg.h"
	.file 4 "<built-in>"
	...
	.file 10 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/console/argtable3/argtable3.h"
	.file 11 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/newlib/include/machine/setjmp.h"
	.file 12 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/newlib/include/ctype.h"
	...
	.file 15 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/newlib/include/setjmp.h"
...
.LASF163:
	.string	"arg_rex"
.LASF446:
	.string	"/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/console/argtable3/argtable3.c"
.LASF282:
