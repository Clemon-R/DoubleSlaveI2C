# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c"
# 1 "/home/raphael/rtone/lcd/build/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c"
# 9 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c"
# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/include/wpa/includes.h" 1
# 10 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c" 2
...
# 12 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c" 2
...
# 13 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c" 2
# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/include/wpa2/eap_peer/eap_common.h" 1
# 12 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/include/wpa2/eap_peer/eap_common.h"
# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/include/wpa/wpabuf.h" 1
# 13 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/include/wpa2/eap_peer/eap_common.h" 2
...
# 14 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c" 2
# 25 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c"
int eap_hdr_len_valid(const struct wpabuf *msg, size_t min_payload)
{
 ...
 if (msg == 
# 30 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c" 3 4
           ((void *)0)
# 30 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c"
               )
  return 0;
...
# 66 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c"
const u8 * eap_hdr_validate(int vendor, EapType eap_type,
       const struct wpabuf *msg, size_t *plen)
{
 const struct eap_hdr *hdr;
 ...
 if (!eap_hdr_len_valid(msg, 1))
  return 
# 74 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c" 3 4
        ((void *)0)
# 74 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c"
            ;
 ...
 if (*pos == EAP_TYPE_EXPANDED) {
  ...
  if (len < sizeof(*hdr) + 8) {
   do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "EAP: Invalid expanded EAP " "length" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "EAP: Invalid expanded EAP " "length" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "EAP: Invalid expanded EAP " "length" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "EAP: Invalid expanded EAP " "length" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "EAP: Invalid expanded EAP " "length" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
                ;
   return 
# 86 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c" 3 4
         ((void *)0)
# 86 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c"
             ;
  }
  pos++;
  ...
  if (exp_vendor != vendor || exp_type != (u32) eap_type) {
   do { if ( 3 >= ESP_LOG_INFO ) do { if (ESP_LOG_INFO==ESP_LOG_ERROR ) { esp_log_write(ESP_LOG_ERROR, "wpa", "\033[0;" "31" "m" "E" " (%d) %s: " "EAP: Invalid expanded frame " "type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_WARN ) { esp_log_write(ESP_LOG_WARN, "wpa", "\033[0;" "33" "m" "W" " (%d) %s: " "EAP: Invalid expanded frame " "type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_DEBUG ) { esp_log_write(ESP_LOG_DEBUG, "wpa", "D" " (%d) %s: " "EAP: Invalid expanded frame " "type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else if (ESP_LOG_INFO==ESP_LOG_VERBOSE ) { esp_log_write(ESP_LOG_VERBOSE, "wpa", "V" " (%d) %s: " "EAP: Invalid expanded frame " "type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } else { esp_log_write(ESP_LOG_INFO, "wpa", "\033[0;" "32" "m" "I" " (%d) %s: " "EAP: Invalid expanded frame " "type" "\033[0m" "\n", esp_log_timestamp(), "wpa"); } } while(0); } while(0)
              ;
   return 
# 96 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c" 3 4
         ((void *)0)
# 96 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c"
             ;
  }
  ...
  *plen = len - sizeof(*hdr) - 8;
  ...
  if (vendor != EAP_VENDOR_IETF || *pos != eap_type) {
   ...
   return 
# 104 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c" 3 4
         ((void *)0)
# 104 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c"
             ;
  }
...
# 128 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c"
struct wpabuf * eap_msg_alloc(int vendor, EapType type, size_t payload_len,
         u8 code, u8 identifier)
{
 struct wpabuf *buf;
 ...
 if (buf == 
# 138 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c" 3 4
           ((void *)0)
# 138 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c"
               )
  return 
# 139 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c" 3 4
        ((void *)0)
# 139 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c"
            ;
...
# 167 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/wps/eap_common.c"
void eap_update_len(struct wpabuf *msg)
{
 struct eap_hdr *hdr;
