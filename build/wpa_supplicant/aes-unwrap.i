# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/aes-unwrap.c"
# 1 "/home/raphael/rtone/lcd/build/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/aes-unwrap.c"
# 16 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/aes-unwrap.c"
...
# 17 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/aes-unwrap.c" 2
...
# 19 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/aes-unwrap.c" 2
...
# 20 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/aes-unwrap.c" 2
...
int __attribute__((__warn_unused_result__)) fast_aes_128_cbc_decrypt(const uint8_t *key, const uint8_t *iv, uint8_t *data,
              size_t data_len);
# 21 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/aes-unwrap.c" 2
# 31 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/aes-unwrap.c"
int
aes_unwrap(const u8 *kek, int n, const u8 *cipher, u8 *plain)
{
 ...
 if (ctx == 
# 44 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/aes-unwrap.c" 3 4
           ((void *)0)
# 44 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/aes-unwrap.c"
               )
  return -1;
# 54 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/aes-unwrap.c"
 for (j = 5; j >= 0; j--) {
  r = plain + (n - 1) * 8;
  for (i = n; i >= 1; i--) {
   memcpy((b), (a), (8));
