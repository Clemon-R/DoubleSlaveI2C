# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
# 1 "/home/raphael/rtone/lcd/build/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
# 10 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/include/wpa/includes.h" 1
# 11 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c" 2
...
# 13 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c" 2
...
# 14 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c" 2
...
# 15 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c" 2
...
int crypto_ec_point_cmp(const struct crypto_ec *e,
        ...
        const struct crypto_ec_point *b);
# 16 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c" 2
# 26 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
...
# 81 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
...
# 110 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
int nt_password_hash(const u8 *password, size_t password_len,
   u8 *password_hash)
{
 u8 buf[512], *pos;
...
# 132 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
int hash_nt_password_hash(const u8 *password_hash, u8 *password_hash_hash)
{
 size_t len = 16;
 return md4_vector(1, &password_hash, &len, password_hash_hash);
}
# 145 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
void challenge_response(const u8 *challenge, const u8 *password_hash,
     u8 *response)
{
 u8 zpwd[7];
...
# 169 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
int generate_nt_response(const u8 *auth_challenge, const u8 *peer_challenge,
       const u8 *username, size_t username_len,
       const u8 *password, size_t password_len,
       u8 *response)
...
# 197 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
int generate_nt_response_pwhash(const u8 *auth_challenge,
       const u8 *peer_challenge,
       const u8 *username, size_t username_len,
       const u8 *password_hash,
...
# 226 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
int generate_authenticator_response_pwhash(
 const u8 *password_hash,
 const u8 *peer_challenge, const u8 *auth_challenge,
 const u8 *username, size_t username_len,
...
# 285 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
int generate_authenticator_response(const u8 *password, size_t password_len,
    const u8 *peer_challenge,
    const u8 *auth_challenge,
    const u8 *username, size_t username_len,
...
# 308 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
int nt_challenge_response(const u8 *challenge, const u8 *password,
        size_t password_len, u8 *response)
{
 u8 password_hash[16];
...
# 326 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
int get_master_key(const u8 *password_hash_hash, const u8 *nt_response,
        u8 *master_key)
{
...
# 358 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
int get_asymetric_start_key(const u8 *master_key, u8 *session_key,
   size_t session_key_len, int is_send,
   int is_server)
{
...
# 430 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
int encrypt_pw_block_with_password_hash(
 const u8 *password, size_t password_len,
 const u8 *password_hash, u8 *pw_block)
{
...
# 471 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
...
# 494 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
void nt_password_hash_encrypted_with_block(const u8 *password_hash,
          const u8 *block, u8 *cypher)
{
...
# 511 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/wpa_supplicant/src/crypto/ms_funcs.c"
int old_nt_password_hash_encrypted_with_new_nt_password_hash(
 const u8 *new_password, size_t new_password_len,
 const u8 *old_password, size_t old_password_len,
 u8 *encrypted_password_hash)
