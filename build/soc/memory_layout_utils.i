# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c"
# 1 "/home/raphael/rtone/lcd/build/soc//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c"
# 14 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c"
...
# 15 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c" 2
...
# 16 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c" 2
...
# 17 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c" 2
...
# 18 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c" 2
...
static void s_prepare_reserved_regions(soc_reserved_region_t *reserved, size_t count)
{
    ...
    for (size_t i = 0; i < count; i++)
    {
        ...
        ((reserved[i].start < reserved[i].end) ? (void)0 : __assert_func ("/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c", 89, __func__, "reserved[i].start < reserved[i].end"));
        if (i < count - 1) {
            ((reserved[i+1].start > reserved[i].start) ? (void)0 : __assert_func ("/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c", 91, __func__, "reserved[i+1].start > reserved[i].start"));
...
# 126 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c" 3 4
       _Bool 
# 126 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c"
            copy_in_to_out = 
# 126 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c" 3 4
                             1
# 126 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c"
...
# 127 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c" 3 4
       _Bool 
# 127 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c"
            move_to_next = 
# 127 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c" 3 4
                           1
# 127 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c"
        ...
        for (size_t i = 0; i < num_reserved; i++) {
            if (reserved[i].end <= in_start) {
                ...
                copy_in_to_out = 
# 143 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c" 3 4
                                0
# 143 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c"
                                     ;
                break;
            }
                ...
                do { if (3 >= ESP_LOG_VERBOSE) { ets_printf( "V" " (%d) %s: " "Region 0x%08x - 0x%08x contains reserved 0x%08x - 0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, in_start, in_end, reserved[i].start, reserved[i].end); }} while(0)
                                                                                    ;
                ((in_start < reserved[i].start) ? (void)0 : __assert_func ("/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c", 150, __func__, "in_start < reserved[i].start"));
                ((in_end > reserved[i].end) ? (void)0 : __assert_func ("/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c", 151, __func__, "in_end > reserved[i].end"));
                ...
                move_to_next = 
# 163 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c" 3 4
                              0
# 163 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/soc/src/memory_layout_utils.c"
                                   ;
                break;
            }
            else if (reserved[i].start <= in_start) {
