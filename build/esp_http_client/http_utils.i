# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c"
# 1 "/home/raphael/rtone/lcd/build/esp_http_client//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c"
# 15 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c"
...
# 16 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c" 2
...
# 17 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c" 2
...
# 18 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c" 2
...
# 19 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c" 2
...
# 20 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c" 2
...
# 22 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c" 2
...
char *http_utils_join_string(const char *first_str, int len_first, const char *second_str, int len_second)
{
    ...
    char *ret = 
# 31 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c" 3 4
               ((void *)0)
# 31 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c"
                   ;
    if (first_str_len + second_str_len > 0) {
        ret = calloc(1, first_str_len + second_str_len + 1);
        ((ret) ? (void)0 : __assert_func ("/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c", 34, __func__, "ret"));
...
char *http_utils_assign_string(char **str, const char *new_str, int len)
{
    int l = len;
    if (new_str == 
# 44 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c" 3 4
                  ((void *)0)
# 44 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c"
                      ) {
        return 
# 45 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c" 3 4
              ((void *)0)
# 45 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c"
                  ;
    }
    char *old_str = *str;
    if (l <= 0) {
    ...
    if (old_str) {
        ...
        ((old_str) ? (void)0 : __assert_func ("/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c", 53, __func__, "old_str"));
        old_str[l] = 0;
    } else {
        old_str = calloc(1, l + 1);
        ((old_str) ? (void)0 : __assert_func ("/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c", 57, __func__, "old_str"));
    }
...
void http_utils_trim_whitespace(char **str)
{
    char *end, *start;
    if (str == 
# 67 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c" 3 4
              ((void *)0)
# 67 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c"
                  ) {
        return;
    }
    start = *str;
    if (start == 
# 71 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c" 3 4
                ((void *)0)
# 71 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c"
                    ) {
        return;
    }
...
char *http_utils_get_string_between(const char *str, const char *begin, const char *end)
{
    ...
    char *ret = 
# 96 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c" 3 4
               ((void *)0)
# 96 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c"
                   ;
    if (found) {
        found += strlen(begin);
        ...
        if (found_end) {
            ...
            ((ret) ? (void)0 : __assert_func ("/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c", 102, __func__, "ret"));
            memcpy(ret, found, found_end - found);
            return ret;
        }
    }
    return 
# 107 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c" 3 4
          ((void *)0)
# 107 "/home/raphael/espressif/tools/esp32-sdk/esp-idf/components/esp_http_client/lib/http_utils.c"
              ;
}
